...
| 版本 | 日期 | 摘要 |
| --- | --- | --- |
| [v0.1.7](https://github.com/EchoSixHIYA/WebSpeak-client-for-TeamSpeak/releases/tag/v0.1.7) | 2026-09-06 | 增加德语支持、Telegram 群组入口、网络性能面板和丢包率测试，修复 TeamSpeak 探测误报、语言菜单留白与伴奏音量波动。 |
...
| --- | --- | --- |
| [v0.1.7](https://github.com/EchoSixHIYA/WebSpeak-client-for-TeamSpeak/releases/tag/v0.1.7) | 2026-09-06 | Added German support, a Telegram community link, network performance and packet-loss checks; fixed false TeamSpeak probe results, language-menu spacing, and accompaniment volume fluctuations. |
...
| --- | --- | --- |
| [v0.1.7](https://github.com/EchoSixHIYA/WebSpeak-client-for-TeamSpeak/releases/tag/v0.1.7) | 2026-09-06 | Deutsche Oberfläche, Telegram-Link sowie Netzwerk- und Paketverlustprüfung hinzugefügt; falsche TeamSpeak-Messungen, Sprachmenü-Leerraum und Begleitton-Schwankungen behoben. |
